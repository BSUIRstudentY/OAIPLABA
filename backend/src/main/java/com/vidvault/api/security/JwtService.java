package com.vidvault.api.security;
...
public class JwtService {
    ...
    public JwtService(
            @Value("${vidvault.jwt.secret}") String secret,
            @Value("${vidvault.jwt.access-token-ttl-minutes}") long accessTtlMinutes,
            @Value("${vidvault.jwt.refresh-token-ttl-days}") long refreshTtlDays) {
